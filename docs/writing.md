...
*Pieces are written when there's something worth saying, not on a schedule. The first ones are in progress. In the meantime, the work lives in the clinic, in the classroom, and on the podcast.*
...
For more press coverage, podcast interviews, and conference talks, see [Press](/press).
