...
You can read the whole reversal in one word, too — 醫, the word I practise under — but the word only nods along; the proof is older and harder than any glyph. So start where it's least arguable: in the ground.
...
And the word itself only confirms what the ground already shows. 醫, the word I practise under, has a second, attested spelling — 毉 — which swaps the wine jar at its base for 巫, the shaman, in the very same slot. Suggestive, and I'll take the suggestion. Still only colour, though, not proof: the root is probably just "potion," the wine jar, and I'm not telling you the word secretly means "shaman." The proof was in the tomb. The brushwork only agrees with it.
...
Here's something I see in the culture, not in the archive — a register shift from everything above, so take it as colour, not citation. The same quiet move survives in how people talk. The "surgeon" is the exorcist, the "nutritionist" the farmer-herb person, the "physician" the one who quietly works your life issues. You don't say the big word, you say the small one. A little herbology. Some bone-setting. Going to talk to your ancestors. The surface stays polite and the work goes on underneath. So when English shrank 醫 into "acupuncturist," it was a clumsier turn of a move the tradition already knew — except the Chinese label kept a door to the old work, and the English one bricked it up.
...
For the word and the graph, the rigorous source is Axel Schuessler's [*ABC Etymological Dictionary of Old Chinese*](https://uhpress.hawaii.edu/title/abc-etymological-dictionary-of-old-chinese/) (University of Hawai'i Press): it gives the root sense of 醫 (yī) as "potion," then "physician," and it traces 巫 (wū), "shaman, spirit medium, magician," back to the oracle bones. I lean on it precisely to stay out of the folk-etymology trap; the word for doctor does not "mean" shaman, and I say so. I keep the variant 毉 (which sets 巫 where 醫 sets 酉) as a hook, not a proof — the load-bearing evidence is the Mawangdui manuscripts below, not the brushwork. Charles Buck's [*Acupuncture and Chinese Medicine: Roots of Modern Practice*](https://us.singingdragon.com/products/acupuncture-and-chinese-medicine) (Singing Dragon) reads a shaman element into the glyph itself; that's a clinician's reading, colour rather than proof, which is why I set it aside in favour of the harder evidence. For shaman and doctor as one named historical role, Christopher Cullen and Vivienne Lo's [*Medieval Chinese Medicine*](https://www.routledge.com/Medieval-Chinese-Medicine-The-Dunhuang-Medical-Manuscripts/Cullen-Lo/p/book/9780415342957) discusses the "physician-shaman" (yīwū, 巫醫) and the "spirit specialist" as recognized categories, and records the medieval Daoist and Buddhist attacks on those figures, which is where the "the divide was available, and Sun declined it" point comes from.
