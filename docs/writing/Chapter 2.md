...
That's the argument in miniature, and the romantic version of it is wrong, so let me be precise. I'm not saying medicine and magick were ever an undivided blur; the people who did both could tell a spell from a drug, and sometimes said so. I'm saying the line we now treat as ancient and obvious was, to them, optional. It sat on the table for a thousand years, and the figures at the dead center of the tradition kept declining to draw it.

And I'm not quarrelling with historians, who settled this decades ago. The reader I'm arguing with is the one trained where I trained: the licensed acupuncturist handed a Chinese medicine scrubbed of its spirits and told the clean thing is the original article, with the superstition filed off sometime back. That's the picture that's backwards. So start with the part that isn't arguable — not the word, the ground.
...
Only now the character, because the language just confirms what the ground already shows. I opened on 醫 because it's the word for the thing I do, not because it proves anything — and it doesn't. But it nods along: there's a second, attested way of writing it, the variant 毉, which swaps the wine jar at its base for 巫, the shaman, in the very same slot. Suggestive, and I'll take the suggestion. Still only colour, though, not proof — the root is probably just "potion," the wine jar, and I'm not telling you the word secretly means "shaman." The proof was in the tomb. The brushwork only agrees with it.
