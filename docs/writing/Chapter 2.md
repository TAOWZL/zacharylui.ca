...
That's the argument in miniature, and the romantic version of it is wrong, so let me be precise. I'm not saying medicine and magick were ever an undivided blur; the people who did both could tell a spell from a drug, and sometimes said so. I'm saying the line we now treat as ancient and obvious was, to them, optional. It sat on the table for a thousand years, and the figures at the dead center of the tradition kept declining to draw it. The magick was never the add-on; the clean split was.

And I'm not quarrelling with historians, who settled this decades ago. The reader I'm arguing with is the one trained where I trained: the licensed acupuncturist handed a Chinese medicine scrubbed of its spirits and told the clean thing is the original article, with the superstition filed off sometime back. That's the picture that's backwards. So start where the scrubbing started, which is the language.

---

## Start with the word

The character is a hook, so let me use it as one and not lean on it. There's a second, attested way of writing 醫: the variant 毉, which swaps the wine jar at its base for 巫, the shaman, in the very same slot. Suggestive, and I'll take the suggestion. But a glyph is not a proof — the root is probably just "potion," the wine jar, and I'm not telling you the word secretly means "shaman" — and the part of this that isn't arguable was never in the brushwork. It's in the ground.

Start with the shaman, because he got there first. 巫 (wū), the spirit-medium, shows up in the oracle bones, the oldest Chinese writing there is, older in the record than the book-trained physician. There's no tidy English word for what a wū did, because he did all of it at once: medium, healer, exorcist, reader of signs. In that world you couldn't pull "medicine" loose from "spirit," because nobody had drawn the line yet. You gathered a herb by talking to the spirit of the plant. A needle could pull out a thorn or drive out a demon.
