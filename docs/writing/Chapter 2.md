...
That's the argument in miniature. What an outsider would split on sight into "the medicine" and "the magick" was never two things later mixed together. It was one thing later cut apart, and once the words did the cutting, everyone downstream assumed the pieces had always been separate. They weren't.
...
One more thing, and here I'm off the cited record and onto what I've watched from inside the culture, so take it as my own observation, not history I can footnote. Chinese has long done its own quiet version of this, on purpose: a respectable label stapled over the real work. You don't say the big word, you say the small one. A little herbology. Some bone-setting. Going to talk to your ancestors. The surface stays polite and the work goes on underneath. So when English shrank 醫 into "acupuncturist," it was a clumsier version of a move the tradition already knew, except English lost the part the code words had kept.
